...
type SceneNodeProps = NodeProps<SceneNodeType>;

const SceneNode = ({ data: scene }: SceneNodeProps) => {
  ...
  return (
    ...
    >
      <div className="scene hover:ring-1 ring-gray-600 relative border bg-card text-card-foreground dark:bg-neutral-800 rounded-[2px]">
...
export default React.memo(SceneNode) as React.ComponentType<any>;
