...
import {SceneFullData, SceneText} from "@/lib/SceneRepository";
...
const SceneNodeEdit = ({scene}: SceneNodeEditProps) => {
    ...
    const {updateScene, deleteScene} = useSceneMutations();
    ...
    const handleDelete = useCallback(async () => {
        await deleteScene.mutateAsync(Number(scene.id));
        closeSidebar();
    }, [scene, deleteScene]);
