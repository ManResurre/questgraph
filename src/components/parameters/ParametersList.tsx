import { useMemo, useRef, useState, useTransition, memo } from "react";
...
interface ParametersListProps {
  renderItem: React.ComponentType<{ parameter: Parameter; index?: number }>;
}

const ParametersList = ({ renderItem: RenderItem }: ParametersListProps) => {
        ...
        <Box height="35vh">
          ...
          <Virtuoso
            ...
            itemContent={(index: number, parameter: Parameter) => (
              <RenderItem parameter={parameter} index={index} />
            )}
          />
        </Box>
      </Paper>
